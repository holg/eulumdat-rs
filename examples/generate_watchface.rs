use eulumdat::{Eulumdat, Symmetry, diagram::{PolarDiagram, WatchFaceStyle}};
use std::fs;
...
fn main() {
    ...
    ldt.g_angles = vec![0.0, 15.0, 30.0, 45.0, 60.0, 75.0, 90.0, 105.0, 120.0, 135.0, 150.0, 165.0, 180.0];
    ldt.intensities = vec![
        vec![280.0, 275.0, 260.0, 230.0, 180.0, 120.0, 60.0, 25.0, 8.0, 2.0, 0.0, 0.0, 0.0],
        vec![270.0, 265.0, 250.0, 220.0, 170.0, 110.0, 55.0, 22.0, 7.0, 2.0, 0.0, 0.0, 0.0],
        vec![250.0, 245.0, 230.0, 200.0, 150.0, 95.0, 45.0, 18.0, 5.0, 1.0, 0.0, 0.0, 0.0],
        vec![220.0, 215.0, 200.0, 170.0, 125.0, 75.0, 35.0, 12.0, 3.0, 0.0, 0.0, 0.0, 0.0],
    ];
