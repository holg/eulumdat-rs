...
SWIFT_KEY_MAPPINGS = {
    ...
    "app.diagram.isolux": "diagram.isolux",
    "app.diagram.isocandela": "diagram.isocandela",
    "app.diagram.floodlight": "diagram.floodlight",
    # Compare tab (from app section - Swift native)
    "app.tab.compare": "tab.compare",
    "app.tab.bim": "tab.bim",
    "app.compare.title": "compare.title",
    "app.compare.dropHint": "compare.dropHint",
    "app.compare.browse": "compare.browse",
    "app.compare.selectTemplate": "compare.selectTemplate",
    "app.compare.similarity": "compare.similarity",
    "app.compare.metric": "compare.metric",
    "app.compare.delta": "compare.delta",
    "app.compare.clear": "compare.clear",
    "app.compare.cPlaneA": "compare.cPlaneA",
    "app.compare.cPlaneB": "compare.cPlaneB",
    "app.compare.linkSliders": "compare.linkSliders",
    "app.compare.fileB": "compare.fileB",
    "app.compare.emptyTitle": "compare.emptyTitle",
    "app.compare.emptyHint": "compare.emptyHint",
    # BIM panel (from app section - Swift native)
    "app.bim.title": "bim.title",
    "app.bim.noData": "bim.noData",
    "app.bim.exportCSV": "bim.exportCSV",
    "app.bim.exportReport": "bim.exportReport",
    "app.bim.info": "bim.info",
    # Schema validation (from app section - Swift native)
    "app.schema.s001": "schema.s001",
    "app.schema.tm33": "schema.tm33",
    "app.schema.tm32": "schema.tm32",
    "app.schema.valid": "schema.valid",
    "app.schema.invalid": "schema.invalid",
    "app.schema.warnings": "schema.warnings",
    "app.schema.missingFields": "schema.missingFields",
    "app.schema.schemaValidation": "schema.schemaValidation",
    "app.schema.ldtValidation": "schema.ldtValidation",
    "app.schema.fileInfo": "schema.fileInfo",
    # Isolux controls (from app section - Swift native)
    "app.isolux.mountingHeight": "isolux.mountingHeight",
    "app.isolux.tiltAngle": "isolux.tiltAngle",
    "app.isolux.areaSize": "isolux.areaSize",
    # Floodlight controls (from app section - Swift native)
    "app.floodlightCtrl.logScale": "floodlightCtrl.logScale",
    "app.floodlightCtrl.linearScale": "floodlightCtrl.linearScale",
