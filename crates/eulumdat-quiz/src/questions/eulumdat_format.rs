...
pub fn questions() -> Vec<Question> {
    vec![
        ...
        Question {
            ...
            category: Category::EulumdatFormat,
            difficulty: Difficulty::Beginner,
            text: "What does EULUMDAT stand for?".into(),
            options: vec!["European Luminaire Data Transfer".into(), "European Lighting Unit Measurement Data".into(), "EUropean LUMinaire DATa".into(), "Electronic Universal Luminaire Data".into()],
            correct_index: 0,
            explanation: "EULUMDAT stands for EUropean LUMinaire DATa (transfer format), commonly expanded as European Luminaire Data Transfer.".into(),
            reference: Some("EULUMDAT specification".into()),
        },
        Question {
            id: 1014,
